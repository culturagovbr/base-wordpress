...
class Parsedown
{
    ...
    protected function element(array $Element)
    {
        ...
        if (isset($Element['attributes']))
        {
            ...
            // @TODO Corrigir o atributo ID para corresponder ao nome
            if( in_array($Element['name'], $headings) ){
                $idName = strtolower($Element['text']);
        ...
        if (isset($Element['text']))
        {
            ...
            if( in_array($Element['name'], $headings) ){
                ...
                $markup .= '
                    <a href="#'. $idName .'" class="anchor no_click_event" aria-hidden="true">
    ...
    protected function populateHeading( $heading ){
        $i = $this->addItem();
        $this->heading_arr[$i]['heading_level'] = $heading['name'];
        $this->heading_arr[$i]['heading_text'] = str_replace('*', '', $heading['text']);
    }
