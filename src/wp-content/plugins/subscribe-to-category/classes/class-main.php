...
class STC_Main
{
    ...
    private function __construct()
    {
        ...
        add_action('wp_ajax_city_based_on_state', array($this, 'city_based_on_state'));
        add_action('wp_ajax_nopriv_city_based_on_state', array($this, 'city_based_on_state'));
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style('chosen-style', STC_PLUGIN_URL . '/css/chosen.min.css', array());
    ...
    {
        wp_enqueue_script('chosen-script', STC_PLUGIN_URL . '/js/chosen.jquery.min.js', array());
        wp_enqueue_script('stc-script', STC_PLUGIN_URL . '/js/stc-script.js', array());

        wp_localize_script('stc-script', 'ajax_object', array(
    ...
    public function city_based_on_state()
    {
        $json_url = STC_PLUGIN_URL . '/js/states-cities.json';
        $json = file_get_contents($json_url);
        $json = json_decode($json, true);
        $key = array_search($_POST['estado'], array_column($json['estados'], 'sigla'));
        // var_dump( $json['estados'][$key]['cidades'] );
        echo json_encode($json['estados'][$key]['cidades']);
