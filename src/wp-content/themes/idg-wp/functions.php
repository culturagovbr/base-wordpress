...
if ( ! function_exists( 'idg_wp_setup' ) ) :
	...
	function idg_wp_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'idg-wp' ),
		) );
 ...
 */
function idg_wp_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'idg_wp_content_width', 640 );
}
add_action( 'after_setup_theme', 'idg_wp_content_width', 0 );
...
function idg_wp_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'idg-wp' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'idg_wp_widgets_init' );
