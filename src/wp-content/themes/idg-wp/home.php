		...
		<main id="main" class="site-main">
				...
				<section class="services mb-5 mt-5">
						<div class="container">
								<div class="row">
										<div class="col-lg-12">
											<h2 class="section-title mb-4 text-center">Serviços</h2>
										</div>
...
<<<<<<< HEAD
				<section class="mt-5 mb-5">
						<div class="container">
								<div class="row">
									<div class="col-lg-12">
										<h2 class="section-title mb-4 text-center">Notícias</h2>
									</div>
									<div class="col-lg-4">
...
>>>>>>> 919cbff8d846657214015d127624e1d62061b639

				<section style="height: 480px; background-color: #18214a; padding: 45px 0;">
						<div class="container">
								<div class="row">
									<div class="col-lg-12">
										<h2 class="section-title mb-4 text-center text-uppercase" style="color: #fff; font-size: 24px">Agenda Cultural</h2>
									</div>
								</div>
						</div>
				</section>
				...
				<section class="mb-4" style="background: url(<?php echo get_template_directory_uri() . '/assets/img/blue-circles.png'; ?>) #D1E6FF no-repeat left bottom; padding: 30px 0">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<h2 class="section-title mb-4 text-center" style="color: #2D5A92">Conheça o ministério</h2>
								</div>
								<div class="col-sm-12 col-md-6 col-lg-3 mb-4 text-center">
				...
				<section class="mt-5 mb-5">
						<div class="container">
								<div class="row">
									<div class="col-lg-12">
										<h2 class="section-title mb-4 text-center">Conteúdos</h2>
									</div>
			...
			<section class="mt-5 mb-5">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<h2 class="section-title mb-4 text-center">Participação Social</h2>
						</div>
