...
if (!class_exists('EF_Content_Builder_Section_News')) {
    ...
    class EF_Content_Builder_Section_News extends EF_Content_Builder_Section {
        ...
        function __construct() {
            ...
            $this->name = __('News Showcase', 'dxef');
            ...
            $this->options = array(
                ...
                array(
                    'ID' => 'news_detail_button_font_color',
                    'name' => __('News detail button text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                array(
                    'ID' => 'search_form_text_font_color',
                    'name' => __('Search form text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                array(
                    'ID' => 'news_pagination_active_font_color',
                    'name' => __('News pagination active text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                array(
                    'ID' => 'news_pagination_disabled_font_color',
                    'name' => __('News pagination disabled text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                ...
                array(
                    'ID' => 'news_detail_button_font_size',
                    'name' => __('News detail button text size:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
