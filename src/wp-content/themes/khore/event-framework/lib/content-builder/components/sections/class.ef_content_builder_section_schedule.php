    ...
    class EF_Content_Builder_Section_Schedule extends EF_Content_Builder_Section {
        ...
        function __construct() {
            ...
            $this->options = array(
                ...
                array(
                    'ID' => 'session_background_color',
                    'name' => __('Session background color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                array(
                    ...
                    'name' => __('Day bar text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                array(
                    ...
                    'name' => __('Day bar background color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                ...
                array(
                    ...
                    'name' => __('Day bar text size:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
