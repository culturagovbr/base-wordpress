...
<div id="header" role="banner">
    <div id="header-container" class="clearfix" <?php echo ( get_minc_option('header_bg') ) ? 'style="background: url('. get_minc_option('header_bg') . ') right bottom no-repeat;"' : ''; ?>>
        <div class="header-row row-1">
            <div class="col-70">
                <ul id="accessibility">
                    ...
                    <li>
                        <a accesskey="2" href="#primary-menu" id="link-navegacao">
                            Ir para o menu
                            <span>2</span>
                        </a>
                    </li>
